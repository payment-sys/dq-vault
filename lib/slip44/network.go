...
func IsSupportedCoinType(coinType uint16) bool {
	switch coinType {
	case Bitcoin, TestNet, Ethereum, EthereumClassic, Bitshares, Litecoin, Dogecoin, Zcash, Monero, Stellar, Ripple, Cardano, Cosmos, Binance, Polkadot, Solana, Avalanche, Polygon, Fantom, Harmony, Near, Algorand, Filecoin, Tezos, Qtum, Icon, Waves, Nano, Iota, Ontology, Zilliqa, Vechain, Theta, Hedera, Elrond, Tron, Kusama, Grin, Beam:
		return true
	default:
		return false
	}
